        ...
        <>
            ...
            <>
                <div className="Course-Page-Content">
                    <div className='Course-Year-Title'>
                        Academic Year 24-25
                        <hr />
                    </div>

                    <Card style={{width: "30%", float: "left", marginRight: "15px", marginBottom: "15px", textAlign: "left", boxShadow: "2px 2px 5px #A80000"}}>
                        <CardActionArea>
                            ...
                            <CardContent style={{ color: "#FFFFFF", backgroundColor: "#A80000", height: "25px" }}>
                                Carolina Fuentes Toro, Nedjma Ousidhoum
                            </CardContent>
                        </CardActionArea>
                    </Card>
                ...
                <div className="Course-Page-Content">
                    ...
                    <Card style={{width: "30%", float: "left", marginRight: "15px", marginBottom: "15px", textAlign: "left", boxShadow: "2px 2px 5px #A80000"}}>
                        <CardActionArea>
                            ...
                            <CardContent style={{ color: "#FFFFFF", backgroundColor: "#A80000", height: "25px" }}>
                                Bailin Deng, Andrew Jones, Aisha Gul, David Humphreys, Jonathan Gorad
                            </CardContent>
                        </CardActionArea>
                    </Card>
                    ...
                    <Card style={{width: "30%", float: "left", marginRight: "15px", marginBottom: "15px", textAlign: "left", boxShadow: "2px 2px 5px #A80000"}}>
                        <CardActionArea>
                            ...
                            <CardContent style={{ color: "#FFFFFF", backgroundColor: "#A80000", height: "25px" }}>
                                Paul Rosin, Stefano Zappala, Aric Fowler
                            </CardContent>
                        </CardActionArea>
                    </Card>
                ...
                <div className="Course-Page-Content">
                    ...
                    <Card style={{width: "30%", float: "left", marginRight: "15px", marginBottom: "15px", textAlign: "left", boxShadow: "2px 2px 5px #A80000"}}>
                        <CardActionArea>
                            ...
                            <CardContent style={{ color: "#FFFFFF", backgroundColor: "#A80000", height: "25px" }}>
                                Yukun Lai, Aric Fowler, Yingying Wu
                            </CardContent>
                        </CardActionArea>
                    </Card>
                    ...
                    <Card style={{width: "30%", float: "left", marginRight: "15px", marginBottom: "15px", textAlign: "left", boxShadow: "2px 2px 5px #A80000"}}>
                        <CardActionArea>
                            ...
                            <CardContent style={{ color: "#FFFFFF", backgroundColor: "#A80000", height: "25px" }}>
                                Matt Morgan, Neetesh Saxana, Surya Thottam Valappil
                            </CardContent>
                        </CardActionArea>
                    </Card>
                    ...
                    <Card style={{width: "30%", float: "left", marginRight: "15px", marginBottom: "15px", textAlign: "left", boxShadow: "2px 2px 5px #A80000"}}>
                        <CardActionArea>
                            ...
                            <CardContent style={{ color: "#FFFFFF", backgroundColor: "#A80000", height: "25px" }}>
                                Martin Caminada, Crispin Cooper, Daniela Tsaneva
                            </CardContent>
                        </CardActionArea>
                    </Card>
